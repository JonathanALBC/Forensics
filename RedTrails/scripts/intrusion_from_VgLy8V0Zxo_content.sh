...
lhJVXukWibAFfkv() {
    ...
    echo "$ABvnz$QOPjH$gQIxX" | base64 --decode > ./outputs/intrusion.txt
}
...
x7KG0bvubT6dID2() {
	...
	PIx1p="cw=="
	echo "$LQebW$gVR7i$bkzHk$q97up$GYJan$HJj6A$fD9Kc$hpAgs$FqOPN$CpJLT$PIx1p" | base64 --decode >> ./outputs/intrusion.txt
}
